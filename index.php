...
<div class="container-fluid">
    <div class="container">
        ...
        <a href="client%20system/auth%20files/page-passReset.php">
...
<!--<script type="text/javascript" src="js/login client portal/signup.js"></script>-->
...
<script>
    ...
    firebase.auth().onAuthStateChanged(function(user) {
        if (user) {
            window.location.replace("client%20system/auth%20files/page-confirmAlreadySignedIn.php");
        } else {
