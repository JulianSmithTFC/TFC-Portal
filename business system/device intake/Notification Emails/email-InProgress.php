<?php
$subject = "Your Device Ticket is In Progress";
...
$message .= "<h2 style='font-size: 35px; color: #43b756; margin-top: 0px; margin-bottom: 0px;'>In Progress</h2>";
$message .= "</div>";
$message .= "<p style='color: #124d67;'>What does this mean?<br/>Your device is currently being either<br/>looked at, waiting on parts or almost<br/>done with the process.</p>";
$message .= "<h4 style='color: #d02e23;'>*You should receive a phone call or email<br/>at least 4 days after this notification.</h4>";
$message .= "<br/>";
