...
$message .= "<h1 style='color: #f30a00'>Here is Your First<br/>Confirmation Email</h1>";
...
$message .= "<h2 style='font-size: 35px; color: #e8ca51; margin-top: 0px; margin-bottom: 0px;'>Waiting to be Assigned</h2>";
$message .= "</div>";
$message .= "<h4 style='color: #d02e23;'>*This status should not take long.<br/>It should change within a couple of days.</h4>";
$message .= "<br/>";
