...
if (isset($_POST['delete'])) {
    ...
    $message = "Customer with ID of " . $quoteID . " has been deleted";
    ...
    <div class="container-fluid mt-5">
        ...
        <div>
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Are you sure you want to delete this quote</h1>
                    <p class="lead">click to delete this quote</p>
            ...
            <div>
                <a href="dashboardQuote.php" role="button" class="btn btn-primary btn-lg btn-block">Back to dashboard</a>
            </div>
        </div>
