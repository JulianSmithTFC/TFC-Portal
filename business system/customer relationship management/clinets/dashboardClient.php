...
$queryTable = "SELECT * FROM clients ORDER BY clientID DESC";
            ...
            <div class="table-responsive">
                ...
                <table id="client_data" data-order='[[ 0, "desc" ]]' data-page-length='5' class="table table-striped">
                    ...
                    while ($row = mysqli_fetch_array($resultTable)) {
                        ...
                        $fixedUID = str_replace(' ', '%20', $row["uid"]);
                        $fixedFname = str_replace(' ', '%20', $row["fname"]);
                        $fixedLname = str_replace(' ', '%20', $row["lname"]);
                        $fixedEmail = str_replace(' ', '%20', $row["email"]);
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../../website tickets/formNewWebsite.php?uid=<?php echo $fixedUID ?>&fname=<?php echo $fixedFname ?>&lname=<?php echo $fixedLname ?>&email=<?php echo $fixedEmail ?>" >
                                    <button type="button" class="btn btn-sm btn-primary btn-rounded">Create Ticket <i class="fas fa-laptop-medical fa-lg"></i></button>
                                </a>
                            </td>
                            <td>
                                <a href="editFormClient.php?id=<?php echo $row["clientID"] ?>">
                                    <button type="button" class="btn btn-sm btn-primary btn-rounded">Edit <i class="fas fa-edit fa-lg"></i></button>
                                </a>
                                <a href="deleteClientEntry.php?id=<?php echo $row["clientID"] ?>" >
