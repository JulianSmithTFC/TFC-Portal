...
<head>
    ...
    <script>
        firebase.auth().onAuthStateChanged(function(user) {
            if (user == null) {
                window.location.replace("https://tfcportal.com/client%20system/form-newUser.php");
            }
...
<div class="container-fluid">
    <div class="container">
        ...
        <div class="border border-light p-5" align="center">
            ...
            <button class="btn btn-info my-4 btn-block" type="submit" onclick="signout()">Create New Account</button>
